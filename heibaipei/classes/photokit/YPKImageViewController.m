...
-(IBAction)selectImage:(id)sender{
    NSInteger index = (self.imageCollectionView.contentOffset.x + 20 ) / (SCREENWIDTH + 10);
    YPKImageModel *model = self.images[index];
    [SelectImgViewModel selectImgModel:model completion:^{
